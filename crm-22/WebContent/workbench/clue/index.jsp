							...
							<div class="col-sm-10" style="width: 300px;">
								<select class="form-control" id="create-state">
								  ...
								  <c:if test="${not empty clueStateList }">
								  	<c:forEach var="cl" items="${clueStateList }">
								  		<option value="${cl.id }">${cl.text }</option>
								  	</c:forEach>
								  </c:if>
								</select>
							</div>
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/clue/detailClue.do?id=dc7ef2160ea64cec848ad554e25f381f';">张三博士</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
