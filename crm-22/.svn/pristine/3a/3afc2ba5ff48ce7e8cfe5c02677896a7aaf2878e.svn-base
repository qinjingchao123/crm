...
public class QueryMarketActivityStateContextListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		List<DictionaryValue> marketActivityStateList=dvs.queryDictionaryValueByTypeCode("marketActivityStatus");
		//把marketActivityStateList保存到缓存中
		ServletContext context=sce.getServletContext();
		context.setAttribute("marketActivityStateList", marketActivityStateList);
	}
