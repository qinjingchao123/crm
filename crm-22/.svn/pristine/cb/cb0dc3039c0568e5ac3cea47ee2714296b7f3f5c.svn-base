	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form>
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="transactionName" value="${param.company }-">
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="activityName" value="测试01" placeholder="点击上面搜索" readonly>
		  	<input type="hidden" id="activityId" value="412b53c666ba46b4852ad08efa9c4d93">
		  </div>
		</form>
